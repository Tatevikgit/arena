        ...
        <div class="tp-event-content">
            ...
            <div class="tp-event-info">
                <div class="tp-info-box">
                    <p class="heading">
                        <i class="thim-color fa fa-clock-o"></i><?php esc_html_e( 'Սկիզբ', 'eduma' ); ?>
                    </p>
                ...
                <div class="tp-info-box">
                    <p class="heading">
                        <i class="thim-color fa fa-flag"></i><?php esc_html_e( 'Ավարտ', 'eduma' ); ?>
                    </p>
                ...
                <div class="tp-info-box">
                    <p class="heading">
                        <i class="thim-color fa fa-map-marker"></i><?php esc_html_e( 'Հասցե', 'eduma' ); ?>
                    </p>
