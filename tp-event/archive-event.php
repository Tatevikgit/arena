...
?>
	<div class="list-tab-event">
		<ul class="nav nav-tabs">
			<li class="active">
				<a href="#tab-happening" data-toggle="tab"><?php esc_html_e( 'Ընթացիկ մրցույթներ', 'eduma' ); ?></a></li>
			<li><a href="#tab-upcoming" data-toggle="tab"><?php esc_html_e( 'Գալիք մրցույթներ', 'eduma' ); ?></a></li>
			<li><a href="#tab-expired" data-toggle="tab"><?php esc_html_e( 'Նախորդ մրցույթներ', 'eduma' ); ?></a></li>
		</ul>
